...
export function MobileBottomNav({ items }: MobileBottomNavProps) {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-0 z-[40] px-3 pb-[calc(env(safe-area-inset-bottom)+0.9rem)] md:hidden">
      <div className="pointer-events-auto mx-auto max-w-md rounded-[24px] border border-white/60 bg-white/82 p-1.5 shadow-[0_18px_48px_rgba(15,23,42,0.18)] backdrop-blur-xl">
